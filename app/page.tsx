...
const promptIdeas = [
  "Photorealistic Punjabi male lead, age 28, warm sunset light, premium fashion campaign, village road, 85mm portrait lens, visible skin texture, documentary photography.",
  "Luxury desert resort with realistic palm trees, still water reflections, twilight sky, travel magazine style.",
  "Young woman founder, age 32, in a glass office, natural skin texture, subtle under-eye detail, soft window light, candid documentary portrait."
];
        ...
        <form className="studio-card" onSubmit={handleGenerate}>
          ...
          <label className="field">
            ...
            <textarea
              ...
              placeholder="Example: real 30-year-old South Asian woman founder, black blazer, glass office, natural pores, candid expression, 85mm lens, soft daylight"
              value={prompt}
            />
          </label>

          <div className="field hint-box">
            <span>Human realism prompt tip</span>
            <p>
              For lifelike people, include age, ethnicity, clothes, lens,
              lighting, skin texture and facial expression.
            </p>
          </div>
          ...
          {mode === "image" && subject === "character" ? (
            <label className="checkbox-row">
              <input
                checked={realismBoost}
                onChange={(event) => setRealismBoost(event.target.checked)}
                type="checkbox"
              />
              <span>
                Human realism boost: uses a stronger portrait model and more
                detailed skin and camera cues.
              </span>
            </label>
          ) : null}
        ...
        <aside className="studio-card preview-card">
          ...
          <div className="preview-notes">
            <div>
              ...
              <p>
                Subject + age + clothing + location + lighting + lens + facial
                expression.
              </p>
            </div>
            <div>
